-- Update RPC function to support new first_name/last_name fields
-- This updates the atomic user creation function with name handling
...
BEGIN
  ...
  -- Create user record with new name fields
  INSERT INTO users (clerk_id, email, name, first_name, last_name, organisation_id)
  VALUES (p_clerk_id, p_email, p_name, p_first_name, p_last_name, p_organisation_id)
